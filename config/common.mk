...
# Google PinYin
PRODUCT_COPY_FILES += $(shell test -d vendor/broken/prebuilt/google/app/GooglePinYin && \
    find vendor/broken/prebuilt/google/app/GooglePinYin -name '*.apk' \
    -printf '%p:system/app/GooglePinYin/%f ')
PRODUCT_COPY_FILES += $(shell test -d vendor/broken/prebuilt/google/app/GooglePinYin && \
    find vendor/broken/prebuilt/google/app/GooglePinYin -name '*.so' \
    -printf '%p:system/app/GooglePinYin/lib/arm/%f ')

#ForceStop
PRODUCT_COPY_FILES += \
    vendor/broken/prebuilt/ForceStop/ForceStop.apk:system/app/ForceStop/ForceStop.apk
